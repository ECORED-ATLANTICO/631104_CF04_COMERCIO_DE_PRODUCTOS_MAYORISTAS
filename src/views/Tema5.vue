...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.mb-5.align-items-center.justify-content-center
      .col-12.col-lg-9.d-flex.align-items-center.bg_grad-03
        div.p-4
    ...
    .row.mb-5.justify-content-center
      ...
      .col-12.col-lg-8
        .tarjeta.bgr_38.p-2.p-md-4.mb-5
          SlyderA(tipo="b")
            .row.p-3
              .col-md-12.px-4
            ...
            .row.p-3
              .col-md-12.px-4
                span.mb-0.text-bold.etiqueta_5 03. Inclusión laboral
            ...
            .row.p-3
              .col-md-12.px-4
                span.mb-0.text-bold.etiqueta_6 04. Inclusión empresarial
    ...
    .row.justify-content-center(data-aos="flip-down")
      .col-12.col-lg-10
        .row.mb-5.bgr_28.p-3.align-items-center
          .col-12.col-md-2.mb-4.mb-md-0
            figure.d-flex.justify-content-center
              img.img100(src='@/assets/curso/tema1/t1-8.svg', alt='Texto que describa la imagen')
          .col-12.col-md-2.d-flex.align-items-center.mb-4.mb-md-0
    ...
    .row.mb-5.justify-content-center.align-items-center
      ...
      .col-sm-8.col-lg-3.order-1.order-lg-2(data-aos="fade-up-left")
        figure
        ...
        .tarjeta.bgr_31
          .p-4.bgr_43
            .row.justify-content-center
              .col-lg-10
                figure
                  img.mb-4.mb-lg-5(src='@/assets/curso/tema5/t5-20.png', alt='Texto que describa la imagen')
              .col-12
                ul.lista-ul--color
                  li.mb-3.d-flex
                    i.fas.fa-paper-plane.colr_3
                    | Preguntarle si le gustaría recibir ayuda, siempre es mejor preguntar, en vez de asumir que se requiere la ayuda. Muchas personas en situación de discapacidad visual son perfectamente capaces de desplazarse sin ayuda, si la persona indica que le gustaría ayuda, solo hacer lo que solicita y nada más.
                  li.mb-3.d-flex
                    i.fas.fa-paper-plane.colr_3
                    | Ayudar a la persona a usar las escaleras, comenzando por indicar si las escaleras van hacia arriba o hacia abajo y en la medida de lo posible, indicar qué tan largas o empinadas son. Si se está guiando a la persona a dar el primer paso, asegurarse de que la persona en situación de discapacidad tenga tiempo para subir detrás.
                  li.mb-3.d-flex
                    i.fas.fa-paper-plane.colr_3
                    | Apoyar a la persona para que tome asiento, la mejor forma de hacer esto es tomar una silla y poner la mano de la persona en la parte trasera de la silla para que se pueda sentar, mientras se realiza esto, referenciar la altura aproximada de la silla e indicar hacia qué lado está.
                  li.mb-3.d-flex
                    i.fas.fa-paper-plane.colr_3
                    | En la interacción utilizar términos que le sirvan de orientación espacial, para permitir su mejor ubicación. Palabras como arriba, abajo, a la derecha, a la izquierda, detrás, entre otras. Usualmente las personas con discapacidad visual suelen utilizar con frecuencia las palabras “ver” o “mirar”, por lo que no se debe tener prejuicios con el uso de ellas. 
          ...
          .col-12
            .row.bgr_32.p-4
              .col-12.col-lg-2.mb-3.mb-lg-0 
                figure.d-flex.justify-content-center
                  img.img100(src='@/assets/componentes/calendario.svg', alt='Texto que describa la imagen')
    ...
    AcordionA.mb-5(tipo="a" clase-tarjeta="tarjeta tarjeta--azul").bgr_2(data-aos="flip-up")
      ...
      .row(titulo="2. Artículo 13").align-items-center.justify-content-center
        .col-lg-8.mb-4.mb-lg-0.px-5
      ...
      .row(titulo="3. Ley 100 de 1993").align-items-center.justify-content-center
        .col-lg-8.mb-4.mb-lg-0.px-5
        ...
        .col-lg-4
          figure
            img(src='@/assets/curso/tema5/t5-10.png', alt='Texto que describa la imagen')
      .row(titulo="4. Ley 115 de 1994").align-items-center.justify-content-center
        .col-lg-8.mb-4.mb-lg-0.px-5
      ...
      .row(titulo="5. Ley 1098 de 2006 (Código de la Infancia y la Adolescencia)").align-items-center.justify-content-center
        .col-lg-8.mb-4.mb-lg-0.px-5
      ...
      .row(titulo="6. Ley 1346 de 2009").align-items-center.justify-content-center
        .col-lg-8.mb-4.mb-lg-0.px-5
      ...
      .row(titulo="7. Ley 1618 de 2013 (Disposiciones para garantizar el pleno ejercicio de los derechos de las personas con discapacidad)").align-items-center.justify-content-center
        .col-lg-8.mb-4.mb-lg-0.px-5
      ...
      .row(titulo="8. Reglamentación CONPES 166 de 2013").align-items-center.justify-content-center
        .col-lg-8.mb-4.mb-lg-0.px-5
      ...
      .row(titulo="9. Norma Técnica Colombiana (NTC) 6047 de 2013").align-items-center.justify-content-center
        .col-lg-8.mb-4.mb-lg-0.px-5
      ...
      .row(titulo="10. Decreto 1421 de 2017").align-items-center.justify-content-center
        .col-lg-8.mb-4.mb-lg-0.px-5
      ...
      .row(titulo="11. Ley 1966 de 2019").align-items-center.justify-content-center
        .col-lg-8.mb-4.mb-lg-0.px-5
      ...
      .row(titulo="12. Plan Nacional de Desarrollo Colombia 2018- 2022").align-items-center.justify-content-center
        .col-lg-8.mb-4.mb-lg-0.px-5
